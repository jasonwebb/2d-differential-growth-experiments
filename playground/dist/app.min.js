    ...
    function () {
      ...
      _createClass(Path, [{
        ...
        value: function iterate(tree) {
          ...
          try {
            for (var _iterator2 = this.nodes.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        value: function drawPreviousEdges() {
          ...
          try {
            for (var _iterator7 = this.nodeHistory.entries()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    function () {
      ...
      _createClass(SVGLoader, null, [{
        ...
        value: function load(p5, svg) {
          ...
          try {
            for (var _iterator12 = inputPaths[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              var inputPath = _step12.value;
              ...
              try {
                for (var _iterator13 = pathData.commands[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
    ...
    function () {
      ...
      _createClass(World, [{
          ...
          try {
            for (var _iterator19 = this.paths[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
              ...
              if (this.drawHistory) {
                ...
                try {
                  for (var _iterator20 = path.nodeHistory[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                    var nodes = _step20.value;
        ...
        value: function createPathElFromNodes(nodes, isClosed) {
          ...
          try {
            for (var _iterator21 = nodes.entries()[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
        ...
        value: function setDrawNodes(state) {
          ...
          try {
            for (var _iterator22 = this.paths[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
  ...
  20: [function (require, module, exports) {
    ...
    */
    ...
    function setActiveTool(tool) {
      ...
      try {
        for (var _iterator29 = allButtonEls[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
    ...
    function importSVG() {
      ...
      if (file.type === 'image/svg+xml') {
        var objectEl = document.querySelector('#user-file');
        objectEl.data = URL.createObjectURL(file);

        objectEl.onload = function () {
          var thing = SVGLoader.load(p5, 'user-file', Settings);
          console.log(thing);
        };
      }
    }
      ...
      */
      ...
      p5.mouseReleased = function () {
        ...
        switch (activeTool) {
          ...
          case FREEHAND:
            if (p5.mouseButton == p5.LEFT) {
              ...
              var isClosed = false,
                  ...
                  x2 = nodes[0].x,
                  y2 = nodes[0].y; // If end point is very close to starting point, make the path closed
          ...
          case CIRCLE:
            endX = p5.mouseX;
            endY = p5.mouseY; // TODO: create nodes to form ellipse
          ...
          case FREEHAND:
            if (p5.mouseButton == p5.LEFT) {
              ...
              if (nodes.length > 0) {
                ...
                try {
                  for (var _iterator30 = nodes.entries()[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
                    var _step30$value = _slicedToArray(_step30.value, 2),
                        index = _step30$value[0],
                        node = _step30$value[1];
              ...
              var x1 = nodes[nodes.length - 1].x,
                  y1 = nodes[nodes.length - 1].y,
                  x2 = nodes[0].x,
                  y2 = nodes[0].y; // If current point is very near the starting point, highlight the starting point to indicate that the path will close
