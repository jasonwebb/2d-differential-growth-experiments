    ...
    function () {
      ...
      _createClass(Node, [{
        ...
        value: function iterate() {
          this.position = p5.Vector.lerp(this.position, this.nextPosition, this.settings.MaxVelocity); // this.position = this.nextPosition;
    ...
    function () {
      ...
      _createClass(Path, [{
        ...
        value: function applyRepulsion(index) {
          var thoseNodes = this.nodes;
          var rr = this.settings.RepulsionRadius; // "this" doesn't work in custom predicates, so we this is needed for now
        ...
        value: function splitEdges() {
          ...
          try {
            for (var _iterator3 = this.nodes.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              ...
              if (connectedNodes.previousNode != undefined && connectedNodes.previousNode instanceof Node && node.position.dist(connectedNodes.previousNode.position) >= this.settings.MaxDistance && this.nodes.length < this.settings.MaxNodes) {
        ...
        value: function injectNode() {
          ...
          if (connectedNodes.previousNode != undefined && connectedNodes.previousNode instanceof Node && connectedNodes.nextNode != undefined && connectedNodes.nextNode instanceof Node && connectedNodes.previousNode.position.dist(connectedNodes.nextNode.position) > this.settings.MinDistance) {
