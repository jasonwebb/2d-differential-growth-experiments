...
(function () {
    ...
    function () {
      ...
      _createClass(Node, [{
        ...
        value: function iterate() {
          this.position = p5.Vector.lerp(this.position, this.nextPosition, Settings.MaxVelocity); // this.position = this.nextPosition;
  ...
  6: [function (require, module, exports) {
    ...
    */
    ...
    function () {
      ...
      _createClass(Path, [{
        ...
        value: function applyRepulsion(index) {
          var thoseNodes = this.nodes; // Perform knn search to find all neighbors within certain radius

          var neighbors = knn(this.tree, this.nodes[index].position.x, this.nodes[index].position.y, undefined, function (node) {
        ...
        value: function applyAlignment(index) {
          ...
          if (connectedNodes.previousNode != undefined && connectedNodes.previousNode instanceof Node && connectedNodes.nextNode != undefined && connectedNodes.nextNode instanceof Node && !this.nodes[index].isFixed) {
            ...
            var midpoint = this.p5.createVector((this.nodes[index].position.x + connectedNodes.previousNode.position.x) / 2, (this.nodes[index].position.y + connectedNodes.previousNode.position.y) / 2); // Move this point towards this midpoint
        ...
        value: function splitEdges() {
          ...
          try {
            for (var _iterator3 = this.nodes.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              ...
              if (connectedNodes.previousNode != undefined && connectedNodes.previousNode instanceof Node && node.position.dist(connectedNodes.previousNode.position) > Settings.MaxDistance && this.nodes.length < Settings.MaxNodes) {
                var midpointNode = new Node(this.p5, this.p5.createVector((node.position.x + connectedNodes.previousNode.position.x) / 2, (node.position.y + connectedNodes.previousNode.position.y) / 2));
        ...
        value: function injectNode() {
          ...
          if (connectedNodes.previousNode != undefined && connectedNodes.previousNode instanceof Node && connectedNodes.nextNode != undefined && connectedNodes.nextNode instanceof Node && connectedNodes.previousNode.position.dist(connectedNodes.nextNode.position) > Settings.MinDistance) {
            // Create a new node with a slight vertical deviation to induce asymmetry
            var newNode = new Node(this.p5, p5.Vector.lerp(connectedNodes.previousNode.position, connectedNodes.nextNode.position, 0.5).add(this.p5.createVector(this.p5.random(1), this.p5.random(1)))); // Splice new node into array
    ...
    "../build//node_modules/rbush-knn": 2,
    "../build/node_modules/rbush": 3,
    "./Node": 5,
    "./Settings": 7
  }],
    ...
    function () {
      ...
      _createClass(World, [{
        ...
        value: function restart() {
          ...
          try {
            for (var _iterator7 = this.originalPaths[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
  ...
  9: [function (require, module, exports) {
    ...
    */
    ...
    var sketch = function sketch(p5) {
      // Setup -------------------------------------------------------------
      p5.setup = function () {
        p5.createCanvas(window.innerWidth, window.innerHeight); // p5.frameRate(5);
        // p5.noLoop();
      ...
      function createCircle() {
        var nodes = [];
        var NUM_START_NODES = 11;
        var RADIUS = 5;

        for (var i = 0; i < NUM_START_NODES; i++) {
          var angle = 2 * Math.PI * i / NUM_START_NODES;
      ...
      function createTriangle() {} // Create four nodes to form a rectangle -----------------------------
    ...
    */
    ...
    document.onkeyup = function (e) {
      ...
      if (e.key == 'p') {
        world.paused = !world.paused; // Toggle trace mode with 't'
      } else if (e.key == 't') {
