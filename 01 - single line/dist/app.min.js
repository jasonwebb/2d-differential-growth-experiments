    ...
    */
    ...
    var sketch = function sketch(p5) {
      ...
      p5.setup = function () {
        ...
        p5.colorMode(p5.HSB, 255); // p5.noLoop();
      ...
      function restartWorld() {
        // Draw line
        world.clearPaths();
        world.addPath(new Path(p5, createLine(), false, Settings)); // Draw the first frame, then pause

        world.drawBackground();
        world.draw(); // world.pause();
