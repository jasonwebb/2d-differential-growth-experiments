...
(function () {
  ...
  2: [function (require, module, exports) {
    ...
    var SQUARE = 0,
        ...
        SVG_TEXT = 3,
        SVG_MAZE = 4;
    var currentBoundsType = SVG_TEXT;
    /*
    =============================================================================
      Main sketch
    =============================================================================
    */
    ...
    var sketch = function sketch(p5) {
      ...
      function restartWorldWith(boundsType) {
        ...
        switch (currentBoundsType) {
          ...
          case MULTIPLE_SHAPES:
            ...
            paths.push(path); // Top right - triangle
            ...
            path.moveTo(175, -175);
            path.setBounds(new Bounds(p5, bounds.toArray()));
            paths.push(path); // Bottom left - square
            ...
            path.moveTo(-175, 175);
            path.setBounds(new Bounds(p5, bounds.toArray()));
            paths.push(path); // Bottom right - square
          ...
          case SVG_TEXT:
            var letters = SVGLoader.load(p5, 'text', Settings);
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;

            try {
              for (var _iterator2 = letters.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var _step2$value = _slicedToArray(_step2.value, 2),
                    index = _step2$value[0],
                    letter = _step2$value[1];
        ...
        world.addPaths(paths); // Draw the first frame, then pause
      ...
      function createPolygonPath(nodeCount, radius) {
        ...
        for (var i = 0; i < nodeCount; i++) {
          ...
          nodes.push(new Node(p5, window.innerWidth / 2 + x, window.innerHeight / 2 + y, Settings));
        }

        var path = new Path(p5, nodes, Settings, true);
        return path;
  ...
  3: [function (require, module, exports) {
    ...
    "./node_modules/point-in-polygon": 10
  }],
    ...
    */
    ...
    function (_Vec) {
      ...
      function Node(p5, x, y) {
        ...
        _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Node).call(this, x, y));
        _this2.p5 = p5;
    ...
    function () {
      ...
      _createClass(Path, [{
        ...
        value: function drawPreviousEdges() {
          ...
          try {
            for (var _iterator8 = this.nodeHistory.entries()[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
              var _step8$value = _slicedToArray(_step8.value, 2),
                  index = _step8$value[0],
                  nodes = _step8$value[1];
        ...
        value: function drawCurrentNodes() {
          ...
          try {
            for (var _iterator9 = this.nodes.entries()[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
    ...
    */
    ...
    function () {
      ...
      _createClass(SVGLoader, null, [{
        key: "load",
        value: function load(p5, svg) {
          var settings = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Defaults;
          this.settings = Object.assign({}, Defaults, settings); // Load the default SVG file
          ...
          try {
            for (var _iterator13 = inputPaths[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
              var inputPath = _step13.value;
              ...
              try {
                for (var _iterator14 = pathData.commands[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
                  var command = _step14.value;
  ...
  8: [function (require, module, exports) {
    ...
    */
    ...
    function () {
      ...
      _createClass(World, [{
          ...
          try {
            for (var _iterator20 = this.paths[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
              ...
              if (this.drawHistory) {
                ...
                try {
                  for (var _iterator21 = path.nodeHistory[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
                    var nodes = _step21.value;
        ...
        value: function createPathElFromNodes(nodes, isClosed) {
          ...
          try {
            for (var _iterator22 = nodes.entries()[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
        ...
        value: function setDrawNodes(state) {
          ...
          try {
            for (var _iterator23 = this.paths[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
              var path = _step23.value;
        ...
        value: function setDebugMode(state) {
          ...
          try {
            for (var _iterator24 = this.paths[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
              var path = _step24.value;
        ...
        value: function setFillMode(state) {
          ...
          try {
            for (var _iterator25 = this.paths[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
        ...
        value: function setDrawHistory(state) {
          ...
          try {
            for (var _iterator26 = this.paths[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
        ...
        value: function setDrawBounds(state) {
          ...
          try {
            for (var _iterator27 = this.paths[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
        ...
        value: function toggleTraceMode() {
          ...
          try {
            for (var _iterator28 = this.paths[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
        ...
        value: function toggleInvertedColors() {
          ...
          try {
            for (var _iterator29 = this.paths[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
    ...
    "./Defaults": 4,
    "./node_modules/file-saver": 9,
    "./node_modules/rbush": 13,
    "./node_modules/svg-points/": 15
  }],
      ...
      (function (a, b) {
        ...
        function b(a, b) {
          return "undefined" == typeof b ? b = {
            autoBom: !1
          } : "object" != _typeof2(b) && (console.warn("Depricated: Expected third argument to be a object"), b = {
            autoBom: !b
        ...
        var f = function () {
          try {
            ...
            return "object" == (typeof window === "undefined" ? "undefined" : _typeof2(window)) && window.window === window ? window : "object" == (typeof self === "undefined" ? "undefined" : _typeof2(self)) && self.self === self ? self : "object" == _typeof2(global) && global.global === global ? global : this;
          }
        }(),
          ...
          if (f = f || e.name || "download", "string" != typeof e) navigator.msSaveOrOpenBlob(b(e, g), f);else if (d(e)) c(e, f, g);else {
        ...
        module.exports = f.saveAs = a.saveAs = a;
      });
