    ...
    */
    ...
    var sketch = function sketch(p5) {
      ...
      function restartWorld() {
        // Create a circle
        world.addPath(new Path(p5, createCircle(p5.random(-600, 600), p5.random(-300, 300), p5.random(10, 200)), true, Settings)); // Create a triangle

        world.addPath(new Path(p5, createTriangle(p5.random(-600, 600), p5.random(-300, 300), p5.random(10, 200), p5.random(0, 360)), true, Settings)); // Create a square

        world.addPath(new Path(p5, createSquare(p5.random(-600, 600), p5.random(-300, 300), p5.random(10, 200), p5.random(0, 360)), true, Settings)); // Draw the first frame, then pause
    ...
    function () {
      ...
      _createClass(Path, [{
        ...
        value: function applyRepulsion(index) {
          ...
          var neighbors = knn(this.tree, this.nodes[index].x, this.nodes[index].y, undefined, undefined, this.settings.RepulsionRadius * this.settings.RepulsionRadius); // radius must be squared as per https://github.com/mourner/rbush-knn/issues/13
